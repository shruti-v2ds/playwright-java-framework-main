Feature: User Registration
  ...
  @NeedsCleanup
  @firstscenario1
  Scenario: User fills registration form and creates profile with new mobile from Excel row 1
  ...
  @firstscenario
  @NeedsCleanup
  Scenario: User fills registration form and creates profile with new mobile from Excel row 2
    When user clicks on Login Signup button
  ...
  @firstscenario
  @NeedsCleanup
  Scenario: User fills registration form and creates profile with new mobile from Excel row 3
    When user clicks on Login Signup button
